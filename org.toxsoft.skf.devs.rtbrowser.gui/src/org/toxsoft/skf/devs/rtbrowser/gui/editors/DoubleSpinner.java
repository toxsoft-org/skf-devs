...
import static org.toxsoft.skf.devs.rtbrowser.gui.editors.ITsResources.*;
...
/**
 * Копия ({@link ValedDoubleSpinner}) для ввода значений с плавающей запятой больше 1000.
 * <p>
...
public class DoubleSpinner
   ...
   */
  public static final int MAX_FLOATING_DIGITS = 3;

  /**
   * Максимальный множитель преобразования double атомарно значения в int значение спинера.
   */
  private static final int MAX_FACTOR = 10 * 10 * 10; // 10 в степени MAX_FLOATING_DIGITS
  ...
  static class Factory
    ...
    protected IValedControl<Double> doCreateEditor( ITsGuiContext aContext ) {
      return new DoubleSpinner( aContext );
    }
   ...
   */
  public DoubleSpinner( ITsGuiContext aContext ) {
    super( aContext );
